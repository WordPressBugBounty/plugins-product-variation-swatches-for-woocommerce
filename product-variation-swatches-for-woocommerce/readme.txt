...
14. Checkmark with Border
15. Swatches on Additional Info
...
= 2.2.0 =
* Added compatibility with [WooCommerce Product Bundles](https://woocommerce.com/products/product-bundles/) plugin.
* Added compatibility with [WooCommerce Composite Products](https://woocommerce.com/products/composite-products/) plugin.
